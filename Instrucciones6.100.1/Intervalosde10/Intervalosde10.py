...
# ----------------------25 operaciones----------------------
nombre_archivo = "./Instrucciones6.100.1/Intervalosde10/dataTime/25_procesos.csv"
...
# ----------------------50 operaciones----------------------
nombre_archivo = "./Instrucciones6.100.1/Intervalosde10/dataTime/50_procesos.csv"
with open(nombre_archivo, 'w', newline='') as archivo_csv:
    escritor = csv.writer(archivo_csv)
    env = simpy.Environment()
    ram = simpy.Container(env, init=100, capacity=100)
...
# ----------------------100 operaciones----------------------
nombre_archivo = "./Instrucciones6.100.1/Intervalosde10/dataTime/100_procesos.csv"
with open(nombre_archivo, 'w', newline='') as archivo_csv:
    escritor = csv.writer(archivo_csv)
    env = simpy.Environment()
    ram = simpy.Container(env, init=100, capacity=100)
...
# ----------------------150 operaciones----------------------
nombre_archivo = "./Instrucciones6.100.1/Intervalosde10/dataTime/150_procesos.csv"
with open(nombre_archivo, 'w', newline='') as archivo_csv:
    escritor = csv.writer(archivo_csv)
    env = simpy.Environment()
    ram = simpy.Container(env, init=100, capacity=100)
...
# ----------------------200 operaciones----------------------
nombre_archivo = "./Instrucciones6.100.1/Intervalosde10/dataTime/200_procesos.csv"
with open(nombre_archivo, 'w', newline='') as archivo_csv:
    escritor = csv.writer(archivo_csv)
    env = simpy.Environment()
    ram = simpy.Container(env, init=100, capacity=100)
